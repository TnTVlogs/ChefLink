...
import me.sergidalmau.cheflink.ui.screens.LoginScreen
import me.sergidalmau.cheflink.ui.screens.OrderScreen
import me.sergidalmau.cheflink.ui.screens.OrdersListScreen
import me.sergidalmau.cheflink.ui.screens.ModeSelectionScreen
import me.sergidalmau.cheflink.ui.screens.SettingsScreen
import me.sergidalmau.cheflink.ui.screens.TablesScreen
                        ...
                        TopAppBar(
                            ...
                            actions = {
                                if (isEditMode) {
                                    ...
                                    Text(user?.firstName ?: "", style = MaterialTheme.typography.bodySmall, modifier = Modifier.padding(end = 16.dp))
                                }
                            },
                    ...
                    if (currentScreen != Screen.Order) {
                        NavigationBar(
                            ...
                            items.forEach { (screen, icon) ->
                                ...
                                NavigationBarItem(
                                    icon = { Icon(icon, contentDescription = labelStr, modifier = Modifier.size(20.dp)) },
                            ...
                            when (currentScreen) {
                                Screen.Tables -> {
                                    TablesScreen(
                                        ...
                                        onCreateTable = { number, capacity -> mainViewModel.createTable(number, capacity) },
                                        onUpdateTable = { number, capacity -> mainViewModel.updateTable(number, capacity) },
                                ...
                                Screen.Order -> {
                                    ...
                                    OrderScreen(
                                        ...
                                        onSendOrder = { newItems, notes ->
                                            val newOrder = Order(
                                                id = editingOrderId ?: "o${Clock.System.now().toEpochMilliseconds()}",
                                                tableNumber = selectedTable ?: orderToEdit?.tableNumber ?: 0,
                                        ...
                                        onBack = {
                                            currentScreen = if (editingOrderId != null) Screen.OrdersList else Screen.Tables
                                            selectedTable = null
                                            editingOrderId = null
                                        },
